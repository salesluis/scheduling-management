        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceInReal = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SchedulingDateOnly = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProfessionalServices_Establishments_EstablishmentId",
                        column: x => x.EstablishmentId,
                        principalTable: "Establishments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_EstablishmentId_ClientId_StartHours",
                table: "Appointments",
                columns: new[] { "EstablishmentId", "ClientId", "StartHours" });

            migrationBuilder.CreateIndex(
                name: "IX_Appointments_EstablishmentId_ProfessionalId_StartHours",
                table: "Appointments",
                columns: new[] { "EstablishmentId", "ProfessionalId", "StartHours" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clients_EstablishmentId_UserId",
                table: "Clients",
                columns: new[] { "EstablishmentId", "UserId" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Professionals_EstablishmentId_UserId",
                table: "Professionals",
                columns: new[] { "EstablishmentId", "UserId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfessionalServices_EstablishmentId_ProfessionalId_ServiceId",
                table: "ProfessionalServices",
                columns: new[] { "EstablishmentId", "ProfessionalId", "ServiceId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Services_EstablishmentId_Name",
                table: "Services",
                columns: new[] { "EstablishmentId", "Name" },
                unique: true);
